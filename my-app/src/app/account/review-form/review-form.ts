...
export class ReviewFormComponent implements OnChanges, OnDestroy {
  ...
  readonly filledStarIcon = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%23f5b301'><path d='M12 2.5l2.94 6.32 6.91.8-5.11 4.73 1.37 6.82L12 17.7 5.89 21.17l1.37-6.82L2.15 9.62l6.91-.8L12 2.5z'/></svg>";
  readonly outlineStarIcon = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23f5b301' stroke-width='1.8' stroke-linejoin='round'><path d='M12 2.5l2.94 6.32 6.91.8-5.11 4.73 1.37 6.82L12 17.7 5.89 21.17l1.37-6.82L2.15 9.62l6.91-.8L12 2.5z'/></svg>";
